...
def bin(bin, table):
    ...
    if table == 'attacke':
        res = cur.execute("delete from invenAttacke where aid = " + bin + ";")
    if table == 'zauber':
        res = cur.execute("delete from invenZauber where zid = " + bin + ";")
    if table == 'gegenstand':
        res = cur.execute("delete from inventar where gid = " + bin + ";")
    db.commit()
